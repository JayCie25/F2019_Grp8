<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tenreg.aspx.cs" Inherits="hfrms.Views.Tenreg" EnableEventValidation="false"%>
...
<body>
    ...
    <input type="number" class="form-control" id="age" runat="server" required>
                ...
                <div class="col mb-2">
                    <asp:Button ID="Button1" runat="server" Text="REGISTER" class="btn btn-success btn-block" OnClick="Button1_Click"/>
                    <script>
